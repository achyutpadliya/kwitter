      ...
      firebase.database().ref("/" + room_name).on('value', function (snapshot) {
            ...
            snapshot.forEach(function (childSnapshot) {
                  ...
                  if (childKey != "purpose") {
                        ...
                        like_buuton = "<button class='btn btn-warning' id="+firebase_message_id+" value="+like+" onclick='updateLike(this.id)'>";
                        span_with_tag = "<span class='glyphicon glyphicon-thumbs-up'>Like: "+like+"</span></button><hr>";

                        row = name_with_tag + message_with_tag + like_buuton + span_with_tag;
